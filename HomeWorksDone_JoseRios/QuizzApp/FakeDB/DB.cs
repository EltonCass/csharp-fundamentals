...
namespace QuizzApp.FakeDB
{
    public class DB
    {
        ...
        {
            new QuestionFillBlank("The Pyramids of Giza are located in _____.", 10, "egypt", 8),
            new QuestionMultipleChoice("What is the color of the 2nd 'G' in Google?", 10, "blue", new string[4] {"Red","Green","Blue","Yellow" }),
            new QuestionFillBlank("In the city of ______ MA, United States. Basketball were invented.", 10, "springfield", 0),
            new QuestionMultipleChoice("Which country won the Fifa World Cup in 2014?", 10, "germany", new string[4] {"Argentina","France","Italy","Germany" }),
        };
        ...
        private static List<Quizz> _quizzes = new List<Quizz>
        {
            ...
            new Quizz(
                ...
                new HashSet<IQuestion>
                    {
                        new QuestionFillBlank("Roger Federer is famous for playing _____.", 10, "tennis", 0),
                        new QuestionMultipleChoice("How many NBA conferences are?", 10, "two", new string[4]{"One", "Two", "Three", "Four"})
                    },
